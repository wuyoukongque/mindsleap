...
date: "2026-06-28"
excerpt: 'monday.com AI assistant Sidekick tried to cover all scenarios with 200 tools — and the system "blew up in front of us." Their final answer was not more agents, but a smarter orchestrator, an on-demand tool discovery mechanism, and a universal toolbox that writes code.'

...
(() => {
  ...
  const stylesheet = `
    ...
    .pdf-download[data-visible] { display: inline-flex; }
    .pdf-download:hover {
      background: #163865;
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // Initial collection + layout happens now and again on slotchange as the
      // parser streams slides into the custom element.
      this._enableRail();
      this._onSlotChange();
